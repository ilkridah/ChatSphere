...
<template>
	<div class="container">
		<div class="profileCard" v-if="dataLoaded">
			...
			:user="user" @update="Update_username"/>
		</div>
		<div class="subCard">
...
<script lang="ts">
	...
	import ProfileCard from '@/components/profile/ProfilCard.vue';
	import MatchHistory from '@/components/profile/MatchHistory.vue'
	import ALeaderBoard from '@/components/profile/ALeadreBoard.vue';
	...
	export default{
		...
		methods:{
			...
			async Update_username(newUsername: string){
