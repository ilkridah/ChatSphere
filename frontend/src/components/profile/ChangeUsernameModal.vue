<template>
	<div class="modal-overlay" @click="closeModal">
		<div class="modal-username" @click.stop>
			<SlidingTitle text="Change UserName"/>
			<div class="username-items">
				<div class="form__group">
					<input type="text" maxlength="15" v-model="username" class="input_username" id="name" placeholder="New UserName"/>
				</div>
				<BlueButton text="Submit" icon="fa-solid fa-pen" @click="changeUsername" />
			</div>
		</div>
	</div>
</template>
