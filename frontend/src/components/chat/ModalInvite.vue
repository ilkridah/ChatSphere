<template>
	<div class="invite_modal_content">
		<div class="invite_text">
				...
				<strong>{{ mode === "duelClassic"}}</strong>
		</div>
		<div class="buttons_invite">
			<button @click="handleClick(true)" class="green_color">Accept</button>
			<button @click="handleClick(false)" class="red_color">Refuse</button>
		</div>
