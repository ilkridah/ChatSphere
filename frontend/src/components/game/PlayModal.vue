	...
	<div class="play-modal-overlay" @click="$emit('close-modal')">
		<div class="modal" @click.stop>
			...
			<div class="buttons-play-modal">
				<BlueButton class="button-play-modal" text="Classic" @click="goToPong('classic')"></BlueButton>
				<BlueButton class="button-play-modal" text="Ranked" @click="goToPong('ranked')"></BlueButton>
			</div>
		</div>
	</div>
</template>
